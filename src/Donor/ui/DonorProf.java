 ...
 * @author MSI-PC
 */
public class DonorProf extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonorProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
