 ...
 * @author MSI-PC
 */
public class StaffPass extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
