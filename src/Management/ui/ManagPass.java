 ...
 * @author MSI-PC
 */
public class ManagPass extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
