 ...
 * @author MSI-PC
 */
public class ManagCreateDonor extends javax.swing.JFrame {

    /**
     * Creates new form ManagCreateDonor
     */
    public ManagCreateDonor() {
        initComponents();
    }
    ...
    private void SingUp1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SingUp1ActionPerformed
        // TODO add your handling code here:
        /*try{
            String query = "insert into DONOR (DonorID,Donor_Name, Donor_Age, Donor_Adress, Donor_Email, Donor_Blood_Group, Donor_Username, Donor_password, donor_secquesans, Donor_NRIC, Donor_contactnum) values ()"
        }
        catch(Exception e){*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagCreateDonor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
